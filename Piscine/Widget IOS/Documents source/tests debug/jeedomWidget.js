...
class Configuration {
  ...
  jeedomBaseUrl = 'http://192.168.1.2'; // location of your system running jeedom, local or external e.g. http://192.168.178.33:8581 or dns
  apiKey = '3mGJZY7c0ZY7E2TYi5nG2yeKwqupTkZN'; // find in Jeedom > Réglage > Système > Configuration > API
  ...
  jeedomData = {
    'header': [ // only 4 items in header MAX
      {
        ...
        'id': 268, // id of data you want to get from Jeedom
    ...
    'content': {
      'firstColumn': {
        ...
        'data': [
          {
            'title': 'Temperature eau', // title you want to display in widget
            'type': 'cmd', // type in jeedom API query
            'id': 267, // id of data you want to display,
            'unit': null // unit (null if empty)
          },
          {
            'title': 'Temperature Abris',
            'type': 'cmd',
            'id': 268,
            'unit': null
          },
...
const maxLineWidth = 400; // if layout doesn't look good for you,
const normalLineHeight = 45; // try to tweak the (font-)sizes & remove/add spaces below
