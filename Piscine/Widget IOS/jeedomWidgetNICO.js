  ...
  jeedomData = {
    'header': [ // only 4 items in header MAX
      {
        ...
        'id': 168, // id of data you want to get from Jeedom
    ...
    'content': {
      'firstColumn': {
        ...
        'data': [
          {
            'title': 'Temp Eau', // title you want to display in widget
            'type': 'cmd', // type in jeedom API query
            'id': 167, // id of data you want to display,
      ...
      'secondColumn': {
        ...
        'data': [
          {
            'title': 'Dummy', // title you want to display in widget
            'type': 'cmd', // type in jeedom
            'id': 168, // id of data you want to display
