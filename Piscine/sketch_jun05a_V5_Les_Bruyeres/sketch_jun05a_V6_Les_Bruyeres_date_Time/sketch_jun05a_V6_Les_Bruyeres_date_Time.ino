...
#include <DS3231.h> // Inclusion de la librairie Time
...
// --------------------------------------
//  Envoi Temperature Exterieure à Jeedom
// --------------------------------------
...
// --------------------------------------
//  Envoi de la date de refresh à Jeedom
// --------------------------------------
...
// Date et Heure
  ...
  String refresh = annee + "/"+ mois + "/" + temps + " , " + heure+ ":" + minu;
